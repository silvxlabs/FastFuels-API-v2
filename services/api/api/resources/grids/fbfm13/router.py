"""
api/v2/resources/grids/fbfm13/router.py
...
@router.post(
    ...
    summary="Create a grid from LANDFIRE FBFM13",
    responses=QUOTA_429_RESPONSE,
)
async def create_landfire_fbfm13(
    request: Request,
    domain: VerifiedDomain,
    body: Annotated[
        CreateLandfireFbfm13Request,
        Body(openapi_examples=CREATE_LANDFIRE_FBFM13_OPENAPI_EXAMPLES),
    ],
):
    """
