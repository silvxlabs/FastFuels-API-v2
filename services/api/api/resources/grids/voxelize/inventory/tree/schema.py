...
TREE_BAND_DEFS: dict[TreeBand, dict] = {
    TreeBand.bulk_density_foliage_live: {
        ...
        "description": "Per-voxel bulk density of live foliage.",
        "type": BandType.continuous,
        "unit": "kg/m**3",
    },
    TreeBand.bulk_density_foliage_dead: {
        "key": "bulk_density.foliage.dead",
        "name": "Dead Foliage Bulk Density",
        "description": "Per-voxel bulk density of dead foliage.",
        "type": BandType.continuous,
        "unit": "kg/m**3",
    },
    TreeBand.bulk_density_branchwood_live: {
        "key": "bulk_density.branchwood.live",
        "name": "Live Branchwood Bulk Density",
        "description": "Per-voxel bulk density of live branchwood.",
        "type": BandType.continuous,
        "unit": "kg/m**3",
    },
    TreeBand.bulk_density_branchwood_dead: {
        "key": "bulk_density.branchwood.dead",
        "name": "Dead Branchwood Bulk Density",
        "description": "Per-voxel bulk density of dead branchwood.",
        "type": BandType.continuous,
        "unit": "kg/m**3",
    },
    TreeBand.bulk_density_fine_live: {
        "key": "bulk_density.fine.live",
        "name": "Live Fine Fuel Bulk Density",
        "description": "Per-voxel bulk density of live fine fuels (foliage + fine branchwood).",
        "type": BandType.continuous,
        "unit": "kg/m**3",
    },
    TreeBand.bulk_density_fine_dead: {
        "key": "bulk_density.fine.dead",
        "name": "Dead Fine Fuel Bulk Density",
    ...
    TreeBand.fuel_moisture_live: {
        ...
        "description": "Moisture content of live canopy fuels (% of oven-dry weight).",
        "type": BandType.continuous,
        "unit": "%",
    },
    TreeBand.fuel_moisture_dead: {
        ...
        "description": "Moisture content of dead canopy fuels (% of oven-dry weight).",
        "type": BandType.continuous,
        "unit": "%",
    },
    TreeBand.savr_foliage: {
        "key": "savr.foliage",
        "name": "Foliage Surface-Area-to-Volume Ratio",
        "description": "Surface-area-to-volume ratio of foliage.",
        "type": BandType.continuous,
        "unit": "1/m",
    },
    TreeBand.spcd: {
        "key": "spcd",
        "name": "Species Code",
        "description": "FIA species code (SPCD) of the dominant tree in the voxel.",
    ...
    TreeBand.volume_fraction: {
        "key": "volume_fraction",
        "name": "Crown Volume Fraction",
        "description": "Fraction of the voxel occupied by tree crown.",
        "type": BandType.continuous,
        "unit": None,
    },
}
