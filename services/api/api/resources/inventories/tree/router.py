...
from api.resources.inventories.tree.allometry.router import router as allometry_router
from api.resources.inventories.tree.chm.router import router as chm_router
from api.resources.inventories.tree.pim.fusion.router import router as pim_fusion_router
from api.resources.inventories.tree.pim.router import router as pim_router
from api.resources.inventories.tree.upload.router import router as upload_router
...
router.include_router(
    pim_fusion_router,
    prefix="/pim/fusion",
    tags=["Inventories - Tree PIM Fusion"],
)
router.include_router(
    upload_router, prefix="/upload", tags=["Inventories - Tree Upload"]
)
router.include_router(
    allometry_router, prefix="/allometry", tags=["Inventories - Tree Allometry"]
)
