"""
Integration tests for api/v2/resources/grids/landfire/router.py

Tests LANDFIRE endpoints (FBFM40, Topography).
...
class TestCreateLandfireFbfm40:
    """Test the POST /domains/{domain_id}/grids/landfire/fbfm40 endpoint."""

    def route(self, domain_id):
        return f"/domains/{domain_id}/grids/landfire/fbfm40"
...
class TestCreateLandfireTopography:
    """Test the POST /domains/{domain_id}/grids/landfire/topography endpoint."""

    def route(self, domain_id):
        return f"/domains/{domain_id}/grids/landfire/topography"
