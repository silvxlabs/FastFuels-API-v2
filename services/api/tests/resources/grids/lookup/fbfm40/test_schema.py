"""
Unit tests for api/v2/resources/grids/lookup/fbfm40/schema.py

Tests the FBFM40 lookup schema models and constants. These are pure unit
tests with no external dependencies.
"""

import pytest
from api.resources.grids.lookup.fbfm40.schema import (
