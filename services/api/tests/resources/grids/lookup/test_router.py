...
Tests the FBFM13 and FBFM40 lookup endpoint (POST /domains/{domain_id}/grids/lookup/).
...
def grid_without_fbfm_band(firestore_client, domain_for_testing):
    ...
    by both FBFM40 and FBFM13 lookup tests for the missing-band case."""
...
def second_domain_for_lookup(firestore_client):
    ...
    shared by both FBFM40 and FBFM13 lookup tests."""
