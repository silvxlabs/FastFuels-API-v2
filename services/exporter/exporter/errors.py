"""
Error types for exporter processing.
"""
...
class CancelledException(Exception):
    """Raised when an export document is deleted during processing (user cancelled)."""
...
class ProcessingError(Exception):
    ...
    Attributes:
        code: Machine-readable error code (e.g., "GRID_NOT_FOUND")
