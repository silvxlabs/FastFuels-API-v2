...
@patch("feature.main._load_domain")
@patch("feature.main.dispatch_handler")
@patch("feature.main.update_status")
@patch("feature.main.load_feature")
def test_happy_path(
...
@patch("feature.main.delete_geojson")
@patch("feature.main._load_domain")
@patch("feature.main.dispatch_handler")
@patch("feature.main.update_status")
@patch("feature.main.load_feature")
