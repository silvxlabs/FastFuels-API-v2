...
class ProcessingError(Exception):
    ...
    Codes emitted by treevox:
      INVENTORY_NOT_FOUND, MISSING_COLUMNS, EMPTY_INVENTORY, INVALID_RESOLUTION,
      BIOMASS_COMPONENT_NOT_IMPLEMENTED, UNKNOWN_SOURCE, VOXELIZATION_FAILED,
      DOMAIN_NOT_FOUND, EMPTY_DOMAIN, INVALID_GEOMETRY.
    """
